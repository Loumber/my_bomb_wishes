...
class AppLogger {
  static void warning(Object msg, [StackTrace? stackTrace]) {
    ...
    l.w('''${ansiColor('Warning')}
${ansiColor(msg.toString())}''', stackTrace);
  }

  static void success(Object msg) {
    const AnsiColor ansiColor = AnsiColor.fg(46);

    l.i('''${ansiColor('Success')}
...
class AnsiColor {
  ...
  const AnsiColor.none() : fg = null, bg = null, color = false;

  const AnsiColor.fg(this.fg) : bg = null, color = true;

  const AnsiColor.bg(this.bg) : fg = null, color = true;
